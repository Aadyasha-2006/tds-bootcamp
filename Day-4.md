...
--- Before Day-4 ---
I already knew the basics of how websites and wed applications work, but I had limited knowledge of HTTP methods, APIs, status codes and browser developer tools.
--- 
...
--- After Day-4 ---
I learned how HTTP requests and responses work, how to inspect network traffic using browser developer tools, how to test APIs using curl, and how to build and test simple FastAPI endpoints.
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback ...
The practical API exercises are very helpful. I will further be delving into real-world examples involving API authentication and error handling. 

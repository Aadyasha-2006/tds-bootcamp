...
--- Before Day-3 ---
I already knew basic Python programming and how to run simple Python scripts, but I had little experience with virtual environments, dependency management, and the uv package manager.
--- 
...
--- After Day-3 ---
I learned how to manage Python projects using uv, crete isolated environments, handle dependencies properly, and understand the role of configuration files such as 'pyproject.toml'. I also learned when to use scripts versus Jupyter notebooks.
---
